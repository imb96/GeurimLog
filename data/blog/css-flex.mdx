...
tags: ['css']
draft: false
summary: CSS Flex는 레이아웃, 특히 수평 정렬을 쉽게 구현할 수 있게 해주는 강력한 도구입니다. Flex Container와 Flex Items의 다양한 속성을 활용하여 유연하고 반응형 있는 디자인을 만들 수 있습니다.
---
...
![](/static/images/flex-direction.png)
