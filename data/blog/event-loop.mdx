...
tags: ['javascript']
draft: false
summary: 자바스크립트는 싱글 스레드지만 이벤트 루프를 통해 비동기 작업을 처리합니다. 이벤트 루프는 Call Stack, Web APIs, Callback Queue를 조율하여 비동기 작업의 실행 순서를 관리합니다.
---
